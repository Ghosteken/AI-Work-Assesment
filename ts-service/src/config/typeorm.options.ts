...
import { CandidateIntake1710000000001 } from '../migrations/1710000000001-CandidateIntake';
...
export const getTypeOrmOptions = (
  ...
  migrations: [InitialStarterEntities1710000000000, CandidateIntake1710000000001],
